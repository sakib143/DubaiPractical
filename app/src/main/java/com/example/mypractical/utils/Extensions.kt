...
//fun loadUrlImage(view: ImageView, model: ItemsModel.ItemsModelItem?, placeholderImage: Int?) {
//    view.setImageResource(R.mipmap.ic_launcher)
//    if (model != null) {
//        if (model.productPictures.size > 0)
//            Glide.with(view.context).load(model.productPictures.get(0).PictureUrl)
//                .apply(
//                    RequestOptions()
...
@BindingAdapter("loadImageFromDetails", "placeholderImage", requireAll = false)
fun loadImageFromDetails(view: ImageView, url: String?, placeholderImage: Int?) {
    view.setImageResource(R.mipmap.ic_launcher)
    if (url != null) {
